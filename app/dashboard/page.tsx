...
import type { EventWithCategory, EventInput, Category, CategoryInput } from "@/lib/types";
...
export default function DashboardPage() {
  ...
  const [editingEvent, setEditingEvent] = React.useState<EventWithCategory | null>(null);
  // 削除確認ダイアログ
  ...
  const filteredEvents = events.filter((event) => {
    ...
    const matchesCategory =
      filterCategory === "all" ||
      (filterCategory === "none" ? !event.categoryId : event.categoryId === filterCategory);
